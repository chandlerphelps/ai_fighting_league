...
class Fighter:
    ...
    iconic_features: str = ""
    personality: str = ""
    image_prompt_body_parts: str = ""
    image_prompt_expression: str = ""
    ...
    outfit_coverage: dict = field(default_factory=dict)
    body_type_details: dict = field(default_factory=dict)
    ...
    def from_dict(cls, d: dict) -> "Fighter":
        return cls(
            ...
            image_prompt_body_parts=d.get("image_prompt_body_parts", ""),
            image_prompt_expression=d.get("image_prompt_expression", ""),
            ...
            outfit_coverage=d.get("outfit_coverage", {}),
            body_type_details=d.get("body_type_details", {}),
